...
// import 'package:internshala/Screens/Job_Seeker_screen/Job_seeker_dashboard_page.dart';
...
//       final response = await _authService.roleAssign(email: email, role: role);
...
//             context,
//             MaterialPageRoute(builder: (context) => Job_seeker_dashboard()),
//           );
//         } else {
//           Navigator.pushReplacement(
//             context,
...
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(
//             content: Text(response['message'] ?? 'Role assignment failed'),
//           ),
//         );
//       }
//     } catch (e) {
...
//                   SizedBox(height: 20),
//                   Image.asset(
//                     'Assets/Images/rolepageimg1.jpg',
//                     height: 180,
//                     fit: BoxFit.contain,
//                   ),
//                 ],
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        if (role == "JOBSEEKER") {
          ...
          // This assumes the other role ("employer") is correct
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => HomeScreen()),
          );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: _isLoading && _loadingRole == "JOBSEEKER"
                          ? CircularProgressIndicator(color: Colors.white)
                          : Text(
                              "Apply Now",
                              style: TextStyle(color: Colors.white),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: _isLoading && _loadingRole == "employer"
                          ? CircularProgressIndicator(color: Colors.white)
                          : Text(
                              "Start Hiring",
                              style: TextStyle(color: Colors.white),
